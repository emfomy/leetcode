// Source: https://leetcode.com/problems/path-existence-queries-in-a-graph-i
...
// Since the numbers are sorted, we only need to find the gaps and group the nodes.
class Solution {
 public:
  vector<bool> pathExistenceQueries(      //
    ...
    for (const auto& query : queries) {
      ...
      ans.push_back(groups[u] == groups[v]);
    }
